           ...
           <br /> 
		    <div class="container" style="width:800px;">  
                ...
                <ul class="nav nav-tabs">  
                     ...
                     <li><a data-toggle="tab" href="#cart">Cart <span class="badge"  style="color:#FFFFFF;"><?php if(isset($_SESSION["shopping_cart"])) { echo count($_SESSION["shopping_cart"]); } else { echo '0';}?></span></a></li>  
                </ul>  
                <div class="tab-content">  
                     ...
                     <div class="col-md-4" style="margin-top:100px;">  
                          <div style="border:1px solid #FF7575; background-color:; border-radius:5px; padding:16px; height:350px;" align="center">  
                                    ...
                                    <tr>  
                                         <td colspan="5" align="center">  
                                              <form method="post" action="cart.php">  
                                                   <input type="submit" name="place_order" class="btn btn-warning" value="Check Out" />  
                                              </form>  
                                         </td>  
                                    </tr>  
                                    <?php  
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="f.jpg" alt="New York" width="800" height="500">
      ...
      <div class="item">
        <img src="g.jpg" alt="Chicago" width="800" height="500">
        <div class="carousel-caption">
          <h3>Fine</h3>
      ...
      <div class="item">
        <img src="h.jpg" alt="Los Angeles" width="800" height="500">
        <div class="carousel-caption">
